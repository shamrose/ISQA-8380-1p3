...
def portfolio(request, pk):
    ...
    return render(request, 'portfolio/portfolio.html',{'customers': customers, 'investments': investments,'stocks': stocks,'sum_acquired_value': sum_acquired_value['acquired_value__sum'], 'sum_recent_value': sum_recent_value['recent_value__sum'], 'sum_current_stocks_value': sum_current_stocks_value,'sum_of_initial_stock_value': sum_of_initial_stock_value, 'result': result, 'result_investment': result_investment, 'overall_initial':overall_initial,  'overall_current': overall_current, 'grand_total': grand_total, 'recent_value': recent_value, 'acquired_value':acquired_value})
